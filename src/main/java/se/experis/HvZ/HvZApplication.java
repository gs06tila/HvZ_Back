...
public class HvZApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			Date d1 = new Date(119, 11, 18);
			Date d2 = new Date(119, 11, 30);
		//------------------------------------GAME-----------------------------------------------------//

			Game g1 = new Game("Växjö HvZ Game", wallOfText, "Växjö Zombie Killers game Viagraparken", 14.80599D, 56.87911D, d1, d2);
			...
			GameUser u5 = new GameUser("Craig", "ttttttttt", "password", "kalle@kalle.se", "CraigTheDestroyer");
			gameUserRepository.save(u5);
			GameUser u6 = new GameUser("postmanTest", "ttttttttt", "password", "kalle@kalle.se", "postmanTest");
			gameUserRepository.save(u6);
			GameUser u7 = new GameUser("Postmantest1", "ttttttttt", "password", "kalle@kalle.se", "postmantest1");
			gameUserRepository.save(u7);
			GameUser u8 = new GameUser("postmanTest3", "ttttttttt", "password", "kalle@kalle.se", "postmantest3");
